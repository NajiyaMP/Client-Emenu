    ...
    return (
        <div style={{backgroundColor:"#2d2d2d",borderTop:'1px solid inherit grey'}}>
                ...
                <div>
                    <Row>
                                ...
                                return (
                                    <div key={setting._id} className="mb-4" style={{paddingLeft:'2.5rem'}}> 
                                        ...
                                        <div>
                                            ...
                                            <h4 style={{paddingLeft:'2rem'}}>{setting.companyName}</h4>
                                            <h6 style={{color:'inherit',paddingLeft:'2rem'}}>{setting.address}</h6>
                        ...
                        <Col md={2} className="link-section">
                            ...
                            <ul>
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Bangles</Link>
                                </li>
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Pendents</Link>
                                </li>
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Necklaces</Link>
                                </li>
                            </ul>
                        </Col>   
                        <Col md={2} className="link-section">
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Rings</Link>
                                </li>
                                <li>
                        ...
                        <Col md={2} className="link-section">
                            ...
                            <ul>
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Gold</Link>
                                </li>
                                <li>
                                    <Link to={'/collections'} onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>18kt</Link>
                                </li>
                                <li>
            ...
            <div style={{display:'flex',justifyContent:'center',alignItems:'center',gap:'2.5rem',borderTop:"1px solid grey",padding:'10px 0px'}}>
                <h6 style={{color:'grey'}}>Copyright@2024<span style={{color:'#a8741a'}}> Jewellery</span></h6>
                <div className='d-flex gap-1'>
                    <h6 style={{color:'grey'}}>ALL Right Reserved</h6>
                    <h6 style={{color:'grey'}}>|</h6>
                    <h6 style={{color:'grey'}}>Naher Alahmar</h6>
                </div>        
            </div>
        </div>
